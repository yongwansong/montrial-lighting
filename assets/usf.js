/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 10/9/2024 2:23:31 PM*/
...
/* Begin plugin code */
usf.plugins.push({render_searchResultsProductWishList(s,t,a,e){var i=a.product;return t("div",{class:`ssw-faveiticon sswfaveicon${i.id}`,attrs:{"data-id":i.id}},[t("i",{attrs:{"data-product-id":i.id,"data-count":0,title:"Add to wishlist","data-params":`{"product_id":"${i.id}","event":"fave_button","page":"product_profile"}`},class:"ssw-icon-heart-o ssw-fave-icon ssw-wishlist-element ssw-not-synch"}),t("span",{class:"faves-count"},["..."])])}}),usf.event.raise("rerender");
