/******/ (() => { // webpackBootstrap
  ...
  Shopify.theme.jsMegaMenu = {
    init: function ($section) {
      ...
      Shopify.theme.jsMegaMenu = $.extend(this, Shopify.theme.getSectionData($section));
      ...
      if ($parentMobileElement.find('.has-no-submenu').length) {
        ...
        $parentMobileElement.find('a').after('<span class="close-dropdown" aria-haspopup="true" aria-expanded="false"></span>');
